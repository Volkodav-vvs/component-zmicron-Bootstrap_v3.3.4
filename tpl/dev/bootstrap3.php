    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= Root('i/css/dev/bootstrap3/responsive-embed.less')?>" />
        ...
        <script type="text/javascript" src="<?= Root('i/js/dev/bootstrap3/phantom.js')?>"></script>
